	...
	public function addCustomer($data) {
		...
		if (!empty($data['custom_field']['account'])) {
			...
			foreach ($custom_fields as $custom_field) {
				...
				if ($custom_field['location'] == 'account' && !empty($data['custom_field']['account'][$custom_field_id])) {
					$account_custom_field[$custom_field_id] = $data['custom_field']['account'][$custom_field_id];
				}
			}
		}
